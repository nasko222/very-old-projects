Public Class Form1
    ...
    Private Sub WinningX()
        ...
        If Cell1_X.Checked = True And Cell4_X.Checked = True And Cell7_X.Checked = True Then '#1
            ...
            Call Reset()
            WinsNumberX.Text = WinsNumberX.Text + 1
        End If
    ...
    Private Sub WinningO()
        ...
        If Cell1_O.Checked = True And Cell4_O.Checked = True And Cell7_O.Checked = True Then '#1
            ...
            Call Reset()
            WinsNumberO.Text = WinsNumberO.Text + 1
        End If
    ...
    Private Sub WinsNumberO_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles WinsNumberO.Click

    End Sub

    Private Sub WinsNumberX_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles WinsNumberX.Click
    ...
    Private Sub Button2_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        If WinsNumberX.Text > WinsNumberO.Text Then
            MessageBox.Show("X Win the game")
            End
        End If
        If WinsNumberX.Text < WinsNumberO.Text Then
            MessageBox.Show("O Win the game")
            End
        End If
        If WinsNumberX.Text = WinsNumberO.Text Then
